...
#     as_mmsql(.where = where_org(target_where))
# }
# 
# where_org <- function(target_where) {
...
# }
# 
# sql_conserved <- function(.table, predicted.site, org) {
#     as_mmsql(.where = where_conserved(.table, predicted.site, org))
# }
# 
...
#                        targetscan = "<=",
#                        ">")
#     as_mmsql(.where = as_where(.vars = score_vars, .operator = operator),
#              .orderby = as_orderby(.vars = score_vars, .order = "DESC"))
# 
