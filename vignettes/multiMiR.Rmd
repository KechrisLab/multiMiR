...
[http://multimir.ucdenver.edu/cgi-bin/multimir\_univ.pl](http://multimir.ucdenver.edu/cgi-bin/multimir_univ.pl)
...
`get.multimir()` function searches, combines and summarizes results from all
...
`search.multimir()` it uses the currently set version.
